...
const Headers = ({ verificationCode }) => {
  ...
  const SecurityKeyLink = window.location.href.split('/');
  const securityKey = SecurityKeyLink[3];
 const urlStalowy = window.location.href.includes('192.168.200.30');
  const url = `http://192.168.15.14:3000/${verificationCode}/`;
